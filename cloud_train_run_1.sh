python3 ./code/run_robust_dp_mnist.py --train --BATCH_SIZE 8 --BATCHES_PER_LOT 1\
    ...
    --MAX_PARAM_SIZE 18 --ACCOUNT_NUM 18 --DP_ACCOUNTANT_ITERATION 2\
    --BETA 600.0 --LEARNING_RATE 1e-3 --LEARNING_DECAY_RATE 0.98 --LEARNING_DECAY_STEPS 10000\
