...
class DP_DENOISER:
        ...
        with tf.variable_scope("DP_DENOISER", reuse=reuse_param):
            with tf.variable_scope('AUTOENCODER', reuse=reuse_param) as ae_scope:
                ...
                with tf.variable_scope("BOTT_ENC", reuse=reuse_param) as enc_bott_scope:
                    w_0 = tf.get_variable(initializer=initializer, shape=(4, 4, 3, 16), name="W_conv_0",)
                    b_0 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(16), name="b_conv_0")
                ...
                with tf.variable_scope("ENC", reuse=reuse_param) as enc_scope:
                    w_1 = tf.get_variable(initializer=initializer, shape=(3, 3, 16, 16), name="W_conv_1")
                    b_1 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(16), name="b_conv_1")
                    w_2 = tf.get_variable(initializer=initializer, shape=(4, 4, 16, 64), name="W_conv_2")
                    b_2 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_conv_2")
                    w_3 = tf.get_variable(initializer=initializer, shape=(3, 3, 64, 64), name="W_conv_3")
                    b_3 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_conv_3")
                    w_4 = tf.get_variable(initializer=initializer, shape=(4, 4, 64, 64), name="W_conv_4")
                    b_4 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_conv_4")
                    w_5 = tf.get_variable(initializer=initializer, shape=(3, 3, 64, 64), name="W_conv_5")
                    b_5 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_conv_5")
                    w_6 = tf.get_variable(initializer=initializer, shape=(3, 3, 64, 64), name="W_conv_6")
                    b_6 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_conv_6")
                    w_7 = tf.get_variable(initializer=initializer, shape=(4, 4, 64, 512), name="W_conv_7")
                    b_7 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(512), name="b_conv_7")
                    w_8 = tf.get_variable(initializer=initializer, shape=(3, 3, 512, 512), name="W_conv_8")
                    b_8 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(512), name="b_conv_8")
                    w_9 = tf.get_variable(initializer=initializer, shape=(3, 3, 512, 512), name="W_conv_9")
                    b_9 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(512), name="b_conv_9")
                    ...
                    res = conv_5
                    net = tf.nn.conv2d(conv_5, w_6, strides=[1, 1, 1, 1], padding="SAME")+ b_6
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    ...
                    net = tf.nn.conv2d(conv_6, w_7, strides=[1, 2, 2, 1], padding="SAME")+ b_7
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    ...
                    res = conv_7
                    net = tf.nn.conv2d(conv_7, w_8, strides=[1, 1, 1, 1], padding="SAME")+ b_8
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    ...
                    res = conv_8
                    net = tf.nn.conv2d(conv_8, w_9, strides=[1, 1, 1, 1], padding="SAME")+ b_9
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    conv_9 = ne.layer_norm(net, self.is_training)

                # Decoder
                with tf.variable_scope("DEC", reuse=reuse_param) as dec_scope:
                    w_0 = tf.get_variable(initializer=initializer, shape=(3, 3, 512, 512), name="W_decv_0")
                    b_0 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(512), name="b_decv_0")
                    w_1 = tf.get_variable(initializer=initializer, shape=(3, 3, 512, 512), name="W_decv_1")
                    b_1 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(512), name="b_decv_1")
                    w_2 = tf.get_variable(initializer=initializer, shape=(4, 4, 64, 512), name="W_decv_2")
                    b_2 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_decv_2")
                    w_3 = tf.get_variable(initializer=initializer, shape=(3, 3, 64, 64), name="W_decv_3")
                    b_3 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_decv_3")
                    w_4 = tf.get_variable(initializer=initializer, shape=(3, 3, 64, 64), name="W_decv_4")
                    b_4 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_decv_4")
                    w_5 = tf.get_variable(initializer=initializer, shape=(4, 4, 64, 64), name="W_decv_5")
                    b_5 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_decv_5")
                    w_6 = tf.get_variable(initializer=initializer, shape=(3, 3, 64, 64), name="W_decv_6")
                    b_6 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(64), name="b_decv_6")
                    w_7 = tf.get_variable(initializer=initializer, shape=(4, 4, 16, 64), name="W_decv_7")
                    b_7 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(16), name="b_decv_7")
                    w_8 = tf.get_variable(initializer=initializer, shape=(3, 3, 16, 16), name="W_decv_8")
                    b_8 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(16), name="b_decv_8")
                    #import pdb; pdb.set_trace()


                    res = conv_9
                    net = ne.conv2d(res, w_0, b_0, strides=[1, 1], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    ...
                    res = decv_0
                    net = ne.conv2d(res, w_1, b_1, strides=[1, 1], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    ...
                    res = decv_2 + conv_6
                    net = ne.conv2d(res, w_3, b_3, strides=[1, 1], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    ...
                    res = decv_3
                    net = ne.conv2d(res, w_4, b_4, strides=[1, 1], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    ...
                    net = ne.conv2d_transpose(decv_4, w_5, b_5, strides=[2, 2], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    ...
                    res = decv_5 + conv_3
                    net = ne.conv2d(res, w_6, b_6, strides=[1, 1], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    ...
                    net = ne.conv2d_transpose(decv_6, w_7, b_7, strides=[2, 2], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    decv_7 = ne.layer_norm(net, self.is_training)

                    res = decv_7 + conv_1
                    net = ne.conv2d(res, w_8, b_8, strides=[1, 1], padding="SAME")
                    net = tf.nn.leaky_relu(net)
                    net = ne.drop_out(net, drop_rate, self.is_training)
                    net += res
                    decv_8 = ne.layer_norm(net, self.is_training)
                ...
                with tf.variable_scope("TOP_DEC", reuse=reuse_param) as dec_top_scope:
                    w_8 = tf.get_variable(initializer=initializer, shape=(4, 4, 3, 16), name="W_dec_8")
                    b_8 = tf.get_variable(initializer=tf.zeros_initializer(), shape=(3), name="b_dec_8")
    ...
    def prediction(self, data, reuse_param=False):
        resized_data = tf.image.resize(data*255.0, [224, 224], method=tf.image.ResizeMethod.BILINEAR)

        shift = tf.constant([103.939, 116.779, 123.68], shape=[1, 1, 1, 3])
        data_infer = resized_data - shift
        
        with tf.variable_scope("cifar10cnn", reuse=reuse_param) as cifar10cnn_scope:
            x_ = data_infer
            pre_trained = nets.VGG19(x_, is_training=False, classes=100, use_logits=True)
        ...
        return logits, prediction, accuracy, cifar10cnn_scope
    ...
    def __call__(self, noised_data, data, reuse_param=False):
        ...
        self.data_logits, self.data_prediction, self.clean_accuracy, self.cifar10cnn_scope = self.prediction(self.data)
    ...
    def tf_load_classifier(self, sess, scope=None, name='sliced_ae.ckpt'):
        if scope == None:
            scope = self.cifar10cnn_scope.name
