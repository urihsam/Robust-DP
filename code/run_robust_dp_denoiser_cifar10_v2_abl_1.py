...
def train():
    ...
    with g.as_default():
        ...
        # training
        # OPT  
        model_op_1, model_lot_op_1, _, model_lr_1 = model.optimization(model_loss+model_reg_enc_bott+model_reg_enc+model_reg_dec, 
                        opt_vars=enc_bott_opt_vars+enc_opt_vars+dec_opt_vars, accum_iters=FLAGS.BATCHES_PER_LOT, scope="OPT_1")
