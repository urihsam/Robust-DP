...
def set_flags():
    ...
    # Path
    flags.DEFINE_string("CNN_PATH", "./models/CIFAR100/CNN", "Path of cifar100 cnn")
    flags.DEFINE_string("PRETRAINED_CNN_PATH", "./models/CIFAR10/PRE/CNN", "Path of cifar10 cnn")
    flags.DEFINE_string("CNN_CKPT_RESTORE_NAME", "robust_dp_cnn.ckpt", "Path of cifar100 cnn")
    flags.DEFINE_string("PRETRAINED_CNN_CKPT_RESTORE_NAME", "robust_dp_cnn.ckpt", "Path of cifar100 cnn")
    ...
    flags.DEFINE_string("TRAIN_LOG_FILENAME", "cifar100_train_log.txt", "Path of log for training")
    flags.DEFINE_string("VALID_LOG_FILENAME", "cifar100_valid_log.txt", "Path of log for validation")
    flags.DEFINE_string("TEST_LOG_FILENAME", "cifar100_test_log.txt", "Path of log for testing")
    flags.DEFINE_string("FINETUNE_TRAIN_LOG_FILENAME", "cifar100_fine_train_log.txt", "Path of log for training")
    flags.DEFINE_string("FINETUNE_VALID_LOG_FILENAME", "cifar100_fine_valid_log.txt", "Path of log for validation")
    flags.DEFINE_string("FINETUNE_TEST_LOG_FILENAME", "cifar100_fine_test_log.txt", "Path of log for testing")
