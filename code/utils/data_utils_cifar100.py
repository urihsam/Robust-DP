...
class dataset(object):
    ...
    def __init__(self):
        print("Dataset here")
        (x_train_, y_train_), (x_test, y_test) = tf.keras.datasets.cifar100.load_data()
        ...
        # one hot
        y_train_ = np.array(self._one_hot_encode(y_train_, 100))
        y_test = np.array(self._one_hot_encode(y_test, 100))
