...
def set_flags():
    ...
    # Path
    flags.DEFINE_string("CNN_PATH", "./models/MNIST/CNN", "Path of mnist cnn")
    flags.DEFINE_string("PRETRAINED_CNN_PATH", "./models/MNIST/PRE/CNN", "Path of mnist cnn")
    flags.DEFINE_string("CNN_CKPT_RESTORE_NAME", "robust_dp_cnn.ckpt", "Path of mnist cnn")
    flags.DEFINE_string("PUB_CNN_CKPT_RESTORE_NAME", "robust_pub_cnn.ckpt", "Path of mnist cnn")
    ...
    flags.DEFINE_string("PUB_TRAIN_LOG_FILENAME", "mnist_pub_train_log.txt", "Path of log for training")
    flags.DEFINE_string("PUB_VALID_LOG_FILENAME", "mnist_pub_valid_log.txt", "Path of log for validation")
    flags.DEFINE_string("PUB_TEST_LOG_FILENAME", "mnist_pub_test_log.txt", "Path of log for testing")
